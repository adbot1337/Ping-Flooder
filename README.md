disclaimer:
Ping flooding is considered a form of network attack and is illegal also against network usage policies in many fields. (USE AT OWN RISK.)
...
had the orignal scirpt sitting on a old dell latitude laptop, again use at your OWN RISK, YOU ARE ACCOUNTABLE for ANY DAMAGES(lol if any) done to either yourself or others, do NOT use this, but if you do... use for educational purposes only! 
